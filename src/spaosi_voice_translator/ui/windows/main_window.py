...
class MainWindow(QMainWindow):
    ...
    def on_voice_hotkey_pressed(self) -> None:
        ...
        # Microphone translation is intentionally reversed relative to system audio.
        #
        # Example:
        #   SYS listens English and translates to Russian.
        #   MIC listens Russian and translates to English.
        #
        # This lets the user answer back in the translated language.
        config = MicrophoneTranslationConfig(
            ...
            recognition_language=self.settings_page.target_language_deepgram_code(),
            recognition_language_name=self.settings_page.target_language_deepgram_name(),
            target_language_name=self.settings_page.language_name(),
        )
